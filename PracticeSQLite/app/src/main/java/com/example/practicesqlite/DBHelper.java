...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE CHATRECORD (_id INTEGER PRIMARY KEY AUTOINCREMENT, item TEXT, price INTEGER, create_at TEXT);");
    }
    ...
    public void insert(String create_at, String item, int price) {
        ...
        // DB에 입력한 값으로 행 추가
        db.execSQL("INSERT INTO CHATRECORD VALUES(null, '" + item + "', " + price + ", '" + create_at + "');");
        db.close();
    }
    ...
    public void delete(String item) {
        SQLiteDatabase db = getWritableDatabase();
        // 입력한 항목과 일치하는 행 삭제
        db.execSQL("DELETE FROM CHATRECORD WHERE item='" + item + "';");
        db.close();
    }
